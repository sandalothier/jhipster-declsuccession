...
public class DeclsuccessionKafkaResourceIT {
    ...
    @Autowired
    private DeclsuccessionKafkaProducer producer;

    @Autowired
    private DeclsuccessionKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DeclsuccessionKafkaResource kafkaResource = new DeclsuccessionKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/declsuccession-kafka/publish?message=test"))
