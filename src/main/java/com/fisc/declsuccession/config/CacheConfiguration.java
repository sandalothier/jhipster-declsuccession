package com.fisc.declsuccession.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("declsuccession");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("declsuccession");
        ...
        config.getMapConfigs().put("com.fisc.declsuccession.domain.*", initializeDomainMapConfig(jHipsterProperties));
